...
export class SongEditor {
    ...
    private readonly _noteFilterZoom: HTMLButtonElement = button({ style: "margin-left:0em; margin-right:0.4em; padding-left:0.2em; height:1.5em; max-width: 12px;", onclick: () => this._openPrompt("customNoteFilterSettings") }, "+");
